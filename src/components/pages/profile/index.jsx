      ...
      {sesion ? (
        <section className='profileSection'>
          <div className="section profile-card">
            ...
            <h2>{user.name} <label className='labelEdit'>Editar</label></h2>
          </div>

          <div className="section dataSection">
            <h3>Datos De la Cuenta</h3>
            <p>Telefono: {user.phone} <label className='labelEdit'>Editar</label></p>
            <p>Correo: {user.email} <label className='labelEdit'>Editar</label></p>
